          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">Manage and organize your code snippets</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <button className="group relative bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-6 py-3 rounded-xl flex items-center space-x-2 transition-all duration-300 hover:scale-105 hover:shadow-lg">
                ...
                <span className="relative z-10 font-semibold">New Snippet</span>
              </button>
            </div>
          </div>
        </div>
